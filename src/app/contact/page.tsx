  ...
  return (
    <div>
      ...
      <section className="flex justify-center px-6 pt-12 pb-10 sm:px-10 lg:px-20 lg:pt-[60px] lg:pb-16">
        <div className="flex h-[300px] w-full max-w-[1294px] items-center justify-center rounded-[30px] bg-[#4B4B4B] sm:h-[400px] sm:rounded-[40px] lg:h-[686px] lg:rounded-[50px]">
          <div className="text-center">
            <h1 className="font-urbanist text-[48px] leading-[1.1] font-medium tracking-[3px] text-white uppercase sm:text-[80px] lg:text-[123px]">
              CONTACT
            </h1>
      ...
      <section className="flex justify-center px-6 sm:px-10 lg:px-20">
        <div className="w-full max-w-[1160px]">
          <h2 className="font-urbanist mb-4 text-3xl leading-[1.5] font-medium text-black uppercase sm:text-4xl lg:mb-6 lg:text-[61px]">
            CONTACT
          </h2>
      ...
      <section className="flex justify-center px-6 py-16 sm:px-10 lg:px-20 lg:py-24">
        <div className="w-full max-w-[1160px]">
          <h2 className="font-urbanist mb-6 text-3xl leading-[1.5] font-medium text-black uppercase sm:text-4xl lg:mb-8 lg:text-[61px]">
            Work With Us
          </h2>
